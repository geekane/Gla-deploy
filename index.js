...
const SUB_PATH = process.env.SUB_PATH || 'zzh''z'z';       // const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || 'bec066ff-e57e-4640-ba85-273ee9d004a6'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
